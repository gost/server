...
func createDatastreams(externalURL string) *Endpoint {
	return &Endpoint{
		...
		Operations: []models.EndpointOperation{
			...
			{models.HTTPOperationGet, "/v1.0/{c:.*}/Datastreams{id}/ObservedProperties", HandleGetObservedPropertyByDatastream},
			...
			{models.HTTPOperationGet, "/v1.0/{c:.*}/Datastreams{id}/ObservedProperties/{params}", HandleGetObservedPropertyByDatastream},
